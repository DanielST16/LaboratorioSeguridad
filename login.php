...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6 position-relative">
            <a href="index.php" class="btn btn-secondary btn-login">Ir al registro</a>
            <div class="card">
                ...
                <div class="card-body">
                    <form action="login.php" method="POST">
                        ...
                        <input name="btnRegistrar" type="submit" class="btn btn-success"/>
                        </br>
                        .
                        <?php
                        ...
                        if(!empty($_POST["btnRegistrar"])){
                            if (!empty($_POST["nombre"]) and !empty($_POST["password"])) {
                                ...
                                if(verificarPassword($nombre,$password)){
                                    echo "<div class ='alert alert-success'>Las contraseñas coinciden.</div>";
                                } else {
                                    echo "<div class ='alert alert-danger'>Error, usuario o contraseña incorrectos</div>";
                                }
                            }
                        }
                        ?>
